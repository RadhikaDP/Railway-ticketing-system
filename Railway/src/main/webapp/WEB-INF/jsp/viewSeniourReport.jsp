...
<table >  
<tr><th class="col-xs-1">Train Name</th><th class="col-xs-1">Age</th><th class="col-xs-1">Gender</th></tr>  
   <c:forEach var="pas" items="${pas}">   
   <tr>  
   <td class="col-xs-1">${pas.name}</td>  
   <td class="col-xs-1">${pas.age}</td>  
   <td class="col-xs-1">${pas.gender}</td>  
   </tr>  
   </c:forEach>  
   </table> </div></div></div>
</body>
